class SignupPage {
    ...
    fillForm(deliver) {
        ...
        cy.get('input[name=address-number]').type(deliver.address.numberHouse);
    ...
    alertMessageShouldBe(expectedMessage) {
        //cy.get('.alert-error').should('have.text', expectedMessage);  ---- apenas um elemento
        cy.contains('.alert-error', expectedMessage).should('be.visible') //um elemento ou varios 
    }
